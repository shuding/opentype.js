...
describe.skip('featureQuery.js', function () {
    let arabicFont;
    ...
    describe('getScriptFeature', function () {
        it('should return features indexes of a given script tag', function () {
            /** arab */
            let arabFeaturesIndexes =
                query.arabic.getScriptFeaturesIndexes('arab');
            assert.equal(arabFeaturesIndexes.length, 24);
            /** latin */
            let latnFeaturesIndexes =
                query.latin.getScriptFeaturesIndexes('latn');
        ...
        it('should return a feature lookup tables', function () {
            ...
            const initFeatureLookups =
                query.arabic.getFeatureLookups(initFeature);
            assert.deepEqual(
            ...
            const ligaFeatureLookups =
                query.latin.getFeatureLookups(ligaFeature);
            assert.deepEqual(
        ...
        it('should return subtable lookup method', function () {
            ...
            const initLookupSubtables =
                query.arabic.getLookupSubtables(initLookupTable);
            ...
            const ligaLookupSubtables =
                query.latin.getLookupSubtables(ligaLookupTable);
        ...
        it('should find a substitute - single substitution format 1 (11)', function () {
            ...
            const featureLookups =
                query.arabicChanga.getFeatureLookups(feature);
        ...
        it('should find a substitute - single substitution format 2 (12)', function () {
            const feature = query.arabic.getFeature({
                tag: 'init',
                script: 'arab',
            });
        ...
        it('should find a substitute - ligature substitution format 1 (41)', function () {
            ...
            const lookup = query.latin.getLookupMethod(
                ligaLookupTable,
                ligaSubtable
            );
